...
func (I letterCounter) name() string {
	return "letters"
}
func (I *letterCounter) count(input *string) {
	for _, r := range *input {
...
func (I *letterCounter) total() uint {
	return uint(*I)
}
